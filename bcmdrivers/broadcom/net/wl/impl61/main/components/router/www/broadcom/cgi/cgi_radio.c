 ...
 * $Id: cgi_radio.c 767457 2018-09-12 03:02:21Z $
 */
	...
	if (strstr(caps, "multi-user-beamformer")) {
		if (is11ax == TRUE) {
			websWrite(wp, "<option value=\"1\" %s>VHT SU BFR</option>",
				(nvram_match("wl_txbf_bfr_cap", "1") ||
				nvram_match("wl_txbf_bfr_cap", "0x1")) ? "selected" : "");
			websWrite(wp, "<option value=\"3\" %s>VHT MU BFR</option>",
				(nvram_match("wl_txbf_bfr_cap", "3") ||
				nvram_match("wl_txbf_bfr_cap", "0x3")) ? "selected" : "");
			websWrite(wp, "<option value=\"4\" %s>HE SU BFR</option>",
				(nvram_match("wl_txbf_bfr_cap", "4") ||
				nvram_match("wl_txbf_bfr_cap", "0x4")) ? "selected" : "");
			websWrite(wp, "<option value=\"12\" %s>HE MU BFR</option>",
				(nvram_match("wl_txbf_bfr_cap", "12") ||
				nvram_match("wl_txbf_bfr_cap", "0xc") ||
				nvram_match("wl_txbf_bfr_cap", "0xC")) ? "selected" : "");
			websWrite(wp, "<option value=\"5\" %s>VHT SU + HE SU BFR</option>",
				(nvram_match("wl_txbf_bfr_cap", "5") ||
				nvram_match("wl_txbf_bfr_cap", "0x5")) ? "selected" : "");
			websWrite(wp, "<option value=\"7\" %s>VHT MU + HE SU BFR</option>",
				(nvram_match("wl_txbf_bfr_cap", "7") ||
				nvram_match("wl_txbf_bfr_cap", "0x7")) ? "selected" : "");
			websWrite(wp, "<option value=\"13\" %s>VHT SU + HE MU BFR</option>",
				(nvram_match("wl_txbf_bfr_cap", "13") ||
				nvram_match("wl_txbf_bfr_cap", "0xd") ||
				nvram_match("wl_txbf_bfr_cap", "0xD")) ? "selected" : "");
			websWrite(wp, "<option value=\"15\" %s>VHT MU + HE MU BFR</option>",
				(nvram_match("wl_txbf_bfr_cap", "15") ||
				nvram_match("wl_txbf_bfr_cap", "0xf") ||
				nvram_match("wl_txbf_bfr_cap", "0xF")) ? "selected" : "");
		} else {
	...
	if (strstr(caps, "multi-user-beamformee")) {
		if (is11ax == TRUE) {
			websWrite(wp, "<option value=\"1\" %s>VHT SU BFE</option>",
				(nvram_match("wl_txbf_bfe_cap", "1") ||
				nvram_match("wl_txbf_bfe_cap", "0x1")) ? "selected" : "");
			websWrite(wp, "<option value=\"3\" %s>VHT MU BFE</option>",
				(nvram_match("wl_txbf_bfe_cap", "3") ||
				nvram_match("wl_txbf_bfe_cap", "0x3")) ? "selected" : "");
			websWrite(wp, "<option value=\"4\" %s>HE SU BFE</option>",
				(nvram_match("wl_txbf_bfe_cap", "4") ||
				nvram_match("wl_txbf_bfe_cap", "0x4")) ? "selected" : "");
			websWrite(wp, "<option value=\"12\" %s>HE MU BFE</option>",
				(nvram_match("wl_txbf_bfe_cap", "12") ||
				nvram_match("wl_txbf_bfe_cap", "0xc") ||
				nvram_match("wl_txbf_bfe_cap", "0xC")) ? "selected" : "");
			websWrite(wp, "<option value=\"5\" %s>VHT SU + HE SU BFE</option>",
				(nvram_match("wl_txbf_bfe_cap", "5") ||
				nvram_match("wl_txbf_bfe_cap", "0x5")) ? "selected" : "");
			websWrite(wp, "<option value=\"7\" %s>VHT MU + HE SU BFE</option>",
				(nvram_match("wl_txbf_bfe_cap", "7") ||
				nvram_match("wl_txbf_bfe_cap", "0x7")) ? "selected" : "");
			websWrite(wp, "<option value=\"13\" %s>VHT SU + HE MU BFE</option>",
				(nvram_match("wl_txbf_bfe_cap", "13") ||
				nvram_match("wl_txbf_bfe_cap", "0xd") ||
				nvram_match("wl_txbf_bfe_cap", "0xD")) ? "selected" : "");
			websWrite(wp, "<option value=\"15\" %s>VHT MU + HE MU BFE</option>",
				(nvram_match("wl_txbf_bfe_cap", "15") ||
				nvram_match("wl_txbf_bfe_cap", "0xf") ||
				nvram_match("wl_txbf_bfe_cap", "0xF")) ? "selected" : "");
		} else {
