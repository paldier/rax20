 ...
 *
 * $Id: defaults.c 776554 2019-07-02 09:51:00Z $
 */
...
/* #ifdef __CONFIG_802_11U__ */
	...
	{ "wl_rxchain_pwrsave_pps", "10", 0, 0},	/* Packets per second threshold for
							 * power save
							*/
	{ "wl_rxchain_pwrsave_stas_assoc_check", "0", 0, 0}, /* STAs associated before powersave */
...
#ifdef MFP
	{ "wl_mfp", "-1", NVFLAG_APPLY_TO_VIF, 0},		/* Protected Management Frame */
#endif // endif
	...
	{ "wl_bw_switch_160", "2", 0, 0},		/* bw_switch_160 default enabled */
	...
	{ "wl_sae_anti_clog_threshold", "5", 0, 0},
	{ "wl_sae_sync", "5", 0, 0},
	{ "wl_sae_groups", "19 20 21", 0, 0},
	{ 0, 0, 0, 0 }
};
