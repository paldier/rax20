		    ...
		    u16 config_error, u16 error_indication, const u8 *mac_addr)
{
    ...
    /*foxconn Han edited, 08/02/2019 copy hack code from ORBI-RBR850*/
    char command[512]="";
    sprintf(command,"echo %d > %s",WPS_ACOS_STATUS_FAIL,WPS_STATUS_FILE);
    system(command);
...
void wps_success_event(struct wps_context *wps, const u8 *mac_addr)
{
    ...
    /*foxconn Han edited, 08/02/2019 copy hack code from ORBI-RBR850*/
    char command[512]="";
    sprintf(command,"echo %d > %s",WPS_ACOS_STATUS_SUCCESS,WPS_STATUS_FILE);
    system(command);
...
void wps_pbc_overlap_event(struct wps_context *wps)
{
    /*foxconn Han edited, 08/02/2019 copy hack code from ORBI-RBR850*/
    char command[512]="";
    sprintf(command,"echo %d > %s",WPS_ACOS_STATUS_OVERLAP,WPS_STATUS_FILE);
    system(command);
