...
int pmc_dsl_power_up(void)
{
	...
	/* 63158 VDSL CORE and MIPS are powered on by default but may be powered down by command line */
#if defined(_BCM963158_) || defined(CONFIG_BCM963158)
#ifdef CONFIG_BRCM_IKOS
	ret = 0;
...
#if (defined(_BCM963158_) || defined(CONFIG_BCM963158)) && (CONFIG_BRCM_CHIP_REV != 0x63158A0)
