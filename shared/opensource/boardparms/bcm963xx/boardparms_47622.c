...
static bp_elem_t g_MR60[] = {
    {bp_cpBoardId,               .u.cp = "MR60"},
    {bp_ulCompatChipId,          .u.ul = 0x47622},  /* remove this line when chip id is otp'ed to 0x6755 */
    {bp_ulCompatChipId,          .u.ul = 0x6755},
    ...
    {bp_ulPhyId1,                .u.ul = 0x18 |  PHY_INTEGRATED_VALID | MAC_IF_RGMII_3P3V | PHY_EXTERNAL},
    {bp_ucPhyDevName,            .u.cp = "eth0"},

    /* reset-gpio for the 50210 */
    {bp_usGpioInitState,         .u.us = BP_GPIO_38_AH},

    /* reserve gpio for led */
    {bp_usGpioLedReserved,       .u.us = BP_GPIO_3_AL},  // G
    {bp_usGpioLedReserved,       .u.us = BP_GPIO_7_AL},  // R
    {bp_usGpioLedReserved,       .u.us = BP_GPIO_9_AL},  // B
    {bp_usGpioLedReserved,       .u.us = BP_GPIO_28_AL}, // W

    {bp_ulMemoryConfig,          .u.ul = BP_DDR_SPEED_800_11_11_11 | BP_DDR_TOTAL_SIZE_512MB| BP_DDR_DEVICE_WIDTH_16 | BP_DDR_TOTAL_WIDTH_16BIT | BP_DDR_SSC_CONFIG_1},
    {bp_last}
};

static bp_elem_t g_MS60[] = {
    {bp_cpBoardId,               .u.cp = "MS60"},
    {bp_ulCompatChipId,          .u.ul = 0x47622},  /* remove this line when chip id is otp'ed to 0x6755 */
    {bp_ulCompatChipId,          .u.ul = 0x6755},
...
static bp_elem_t g_RAX20[] = {
    {bp_cpBoardId,               .u.cp = "RAX20"},
    {bp_ulCompatChipId,          .u.ul = 0x6755},
    ...
    {bp_usGpioLedSesWireless,    .u.us = BP_GPIO_1_AH},						/* WPS_LED */
    {bp_usGpioLedWL1Act,         .u.us = BP_GPIO_36_AL | BP_LED_USE_GPIO},	/* WIFI_ACT */
    {bp_usGpioLedWL0Act,         .u.us = BP_GPIO_36_AL | BP_LED_USE_GPIO},	/* WIFI_ACT */
    ...
    /* Power RGB LED. */
    {bp_usGpioLedReserved,         .u.us = BP_GPIO_22_AL},
    {bp_usGpioLedReserved,         .u.us = BP_GPIO_23_AL},
    {bp_usGpioLedReserved,       .u.us = BP_GPIO_10_AL},
	/* WAN RGB LED */
    {bp_usGpioLedReserved,       .u.us = BP_GPIO_15_AL},
    {bp_usGpioLedReserved,       .u.us = BP_GPIO_3_AL},
    {bp_usGpioLedReserved,       .u.us = BP_GPIO_24_AL},

    /* reset-gpio for the external switch. */
    {bp_usGpioInitState,         .u.us = BP_GPIO_26_AH},
    /* Power LED. */
    {bp_usGpioInitState,         .u.us = BP_GPIO_8_AL},

    {bp_ulMemoryConfig,          .u.ul = BP_DDR_SPEED_800_11_11_11 | BP_DDR_TOTAL_SIZE_512MB| BP_DDR_DEVICE_WIDTH_16 | BP_DDR_TOTAL_WIDTH_16BIT | BP_DDR_SSC_CONFIG_1},
    {bp_last}
};

static bp_elem_t g_EAX20[] = {
    {bp_cpBoardId,               .u.cp = "EAX20"},
    {bp_ulCompatChipId,          .u.ul = 0x6755},
    ...
    {bp_usGpioLedReserved,       .u.us = BP_GPIO_3_AL},
    {bp_usGpioLedReserved,       .u.us = BP_GPIO_5_AL},
    {bp_usGpioLedReserved,       .u.us = BP_GPIO_7_AL},
    {bp_usGpioLedReserved,       .u.us = BP_GPIO_8_AL},
    {bp_usGpioLedReserved,       .u.us = BP_GPIO_10_AL},
    {bp_usGpioLedReserved,       .u.us = BP_GPIO_36_AL},
...
bp_elem_t * g_BoardParms[] = {g_bcm947622sv, g_bcm947622rfdvt, g_bcm947622rfdvt2, g_bcm947622ref1, g_bcm96755ref1, g_bcm947622eap, g_bcm947622eap2, g_bcm947622eaps, g_bcm947622sv_serdes, g_bcm947622ref1_sg, g_bcm96755ref1_sg, g_bcm96755tbrhx, \
    g_bcm947622ref1_p250, g_bcm947622ref1_sg_p250, g_bcm96755ref1_p200, g_bcm96755ref1_sg_p200, g_bcm96755ref2, g_RAX20, g_EAX20, g_MR60, g_MS60, 0};
