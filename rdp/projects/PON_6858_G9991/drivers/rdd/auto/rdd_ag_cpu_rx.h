...
int rdd_ag_cpu_rx_udpspdtest_stream_rx_stat_table_set(uint32_t rx_bytes_0, uint32_t rx_bytes_1, uint32_t rx_packets_0, uint32_t rx_packets_1, uint32_t ts_first, uint32_t ts_last_0, uint32_t ts_last_1, bdmf_boolean ts_first_set, uint16_t bad_proto_cntr);
int rdd_ag_cpu_rx_udpspdtest_stream_rx_stat_table_get(uint32_t *rx_bytes_0, uint32_t *rx_bytes_1, uint32_t *rx_packets_0, uint32_t *rx_packets_1, uint32_t *ts_first, uint32_t *ts_last_0, uint32_t *ts_last_1, bdmf_boolean *ts_first_set, uint16_t *bad_proto_cntr);
