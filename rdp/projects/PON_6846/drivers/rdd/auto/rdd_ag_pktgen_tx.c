...
int rdd_ag_pktgen_tx_pktgen_fpm_ug_mgmt_set(uint32_t budget, uint32_t fpm_ug_cnt_dummy, uint32_t fpm_ug_cnt, uint32_t fpm_ug_cnt_reg_addr, uint32_t fpm_ug_threshold)
{
...
int rdd_ag_pktgen_tx_pktgen_fpm_ug_mgmt_get(uint32_t *budget, uint32_t *fpm_ug_cnt_dummy, uint32_t *fpm_ug_cnt, uint32_t *fpm_ug_cnt_reg_addr, uint32_t *fpm_ug_threshold)
{
...
int rdd_ag_pktgen_tx_pktgen_tx_stream_table_set(uint32_t _entry, uint16_t wan_flow, uint16_t tx_qm_queue)
{
    if(_entry >= RDD_PKTGEN_TX_STREAM_TABLE_SIZE)
          return BDMF_ERR_PARM;

    RDD_PKTGEN_TX_STREAM_ENTRY_WAN_FLOW_WRITE_G(wan_flow, RDD_PKTGEN_TX_STREAM_TABLE_ADDRESS_ARR, _entry);
    RDD_PKTGEN_TX_STREAM_ENTRY_TX_QM_QUEUE_WRITE_G(tx_qm_queue, RDD_PKTGEN_TX_STREAM_TABLE_ADDRESS_ARR, _entry);

    return BDMF_ERR_OK;
}

int rdd_ag_pktgen_tx_pktgen_tx_stream_table_get(uint32_t _entry, uint16_t *wan_flow, uint16_t *tx_qm_queue)
{
    if(_entry >= RDD_PKTGEN_TX_STREAM_TABLE_SIZE)
          return BDMF_ERR_PARM;

    RDD_PKTGEN_TX_STREAM_ENTRY_WAN_FLOW_READ_G(*wan_flow, RDD_PKTGEN_TX_STREAM_TABLE_ADDRESS_ARR, _entry);
    RDD_PKTGEN_TX_STREAM_ENTRY_TX_QM_QUEUE_READ_G(*tx_qm_queue, RDD_PKTGEN_TX_STREAM_TABLE_ADDRESS_ARR, _entry);
