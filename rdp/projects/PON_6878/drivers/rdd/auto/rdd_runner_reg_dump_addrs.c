...
static DUMP_RUNNERREG_STRUCT EPON_DDR_CACHE_FIFO =
{
	16,
	{
		{ dump_RDD_BBH_TX_DESCRIPTOR, 0x820 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT SERVICE_QUEUES_SCHEDULING_QUEUE_TABLE =
{
	8,
	{
		{ dump_RDD_SCHEDULING_QUEUE_DESCRIPTOR, 0xe40 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT US_TM_TM_FLOW_CNTR_TABLE =
{
	1,
	{
		{ dump_RDD_TM_FLOW_CNTR_ENTRY, 0xe80 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT REPORTING_QUEUE_ACCUMULATED_TABLE =
{
	16,
	{
		{ dump_RDD_QM_QUEUE_COUNTER_DATA, 0xf00 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT BASIC_SCHEDULER_TABLE_DS =
{
	16,
	{
		{ dump_RDD_BASIC_SCHEDULER_DESCRIPTOR, 0x1500 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT SERVICE_QUEUES_COMPLEX_SCHEDULER_TABLE =
{
	64,
	{
		{ dump_RDD_COMPLEX_SCHEDULER_DESCRIPTOR, 0x1740 },
		{ 0, 0 },
	}
};
#endif
#if defined BCM6878
static DUMP_RUNNERREG_STRUCT US_TM_DDR_QUEUES_BASE_PTR =
{
	8,
	{
		{ dump_RDD_DDR_QUEUES_BASE_PTR, 0x1780 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT US_TM_WAN_0_BBH_TX_WAKE_UP_DATA_TABLE =
{
	8,
	{
		{ dump_RDD_BBH_TX_WAKE_UP_DATA_ENTRY, 0x17c8 },
		{ 0, 0 },
	}
};
#endif
#if defined BCM6878
static DUMP_RUNNERREG_STRUCT US_TM_DDR_PD =
{
	16,
	{
		{ dump_RDD_PROCESSING_TX_DESCRIPTOR, 0x17d0 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT DIRECT_PROCESSING_PAUSE_QUANTA =
{
	2,
	{
		{ dump_RDD_PAUSE_QUANTA_ENTRY, 0x1eb6 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT BBH_TX_EPON_WAKE_UP_DATA_TABLE =
{
	8,
	{
		{ dump_RDD_BBH_TX_WAKE_UP_DATA_ENTRY, 0x1ee8 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT DIRECT_PROCESSING_PD_TABLE =
{
	16,
	{
		{ dump_RDD_PROCESSING_RX_DESCRIPTOR, 0x1ef0 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT COMPLEX_SCHEDULER_TABLE =
{
	64,
	{
		{ dump_RDD_COMPLEX_SCHEDULER_DESCRIPTOR, 0x1f00 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT EPON_DDR_QUEUE_DESCRIPTORS_TABLE =
{
	16,
	{
		{ dump_RDD_DDR_QUEUE_DESCRIPTOR, 0x2410 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT OVERALL_RATE_LIMITER_TABLE =
{
	16,
	{
		{ dump_RDD_OVERALL_RATE_LIMITER_DESCRIPTOR, 0x2490 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT TM_HW_FLUSH =
{
	4,
	{
		{ dump_RDD_HW_FLUSH_ENTRY, 0x24b4 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT GENERAL_QUEUE_DYNAMIC_MNG_TABLE =
{
	8,
	{
		{ dump_RDD_QUEUE_DYNAMIC_MNG_ENTRY, 0x24b8 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT GHOST_REPORTING_GLOBAL_CFG =
{
	4,
	{
		{ dump_RDD_GHOST_REPORTING_GLOBAL_CFG_ENTRY, 0x24fc },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT FW_POLICER_BUDGET =
{
	2,
	{
		{ dump_RDD_FW_POLICER_BUDGET_ENTRY, 0x2500 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT SERVICE_QUEUES_RATE_LIMITER_TABLE =
{
	16,
	{
		{ dump_RDD_BASIC_RATE_LIMITER_DESCRIPTOR, 0x2600 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT EPON_DDR_QUEUE_ADDRESS_TABLE =
{
	8,
	{
		{ dump_RDD_DDR_QUEUE_ADDRESS_ENTRY, 0x2780 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT DS_TM_TM_FLOW_CNTR_TABLE =
{
	1,
	{
		{ dump_RDD_TM_FLOW_CNTR_ENTRY, 0x27e8 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT TX_EXCEPTION =
{
	1,
	{
		{ dump_RDD_TX_EXCEPTION_ENTRY, 0x2ee5 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT RX_MIRRORING_CONFIGURATION =
{
	2,
	{
		{ dump_RDD_MIRRORING_DESCRIPTOR, 0x2eee },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT MAC_TYPE =
{
	1,
	{
		{ dump_RDD_MAC_TYPE_ENTRY, 0x2fb4 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT BASIC_SCHEDULER_TABLE_US =
{
	16,
	{
		{ dump_RDD_BASIC_SCHEDULER_DESCRIPTOR, 0x3000 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT DEBUG_PRINT_TABLE =
{
	16,
	{
		{ dump_RDD_DEBUG_PRINT_INFO, 0x3290 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT FPM_GLOBAL_CFG =
{
	12,
	{
		{ dump_RDD_FPM_GLOBAL_CFG, 0x33b0 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT US_TM_TX_OCTETS_COUNTERS_TABLE =
{
	8,
	{
		{ dump_RDD_PACKETS_AND_BYTES, 0x38a0 },
		{ 0, 0 },
	}
};
#endif
#if defined BCM6878
static DUMP_RUNNERREG_STRUCT US_TM_DDR_QUEUES_WR_IDX =
{
	2,
	{
		{ dump_RDD_BYTES_2, 0x38e0 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT XGPON_REPORT_ZERO_SENT_TABLE =
{
	1,
	{
		{ dump_RDD_BYTE_1, 0x3a48 },
		{ 0, 0 },
	}
};
#endif
#if defined BCM6878
static DUMP_RUNNERREG_STRUCT US_TM_DDR_QUEUES_RD_IDX =
{
	2,
	{
...
static DUMP_RUNNERREG_STRUCT SERVICE_QUEUES_UPDATE_FIFO_TABLE =
{
	4,
	{
		{ dump_RDD_UPDATE_FIFO_ENTRY, 0x3a80 },
		{ 0, 0 },
	}
};
#endif
#if defined BCM6878
static DUMP_RUNNERREG_STRUCT US_TM_DDR_QUEUES_CTR =
{
	2,
	{
		{ dump_RDD_BYTES_2, 0x3aa0 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT EMAC_FLOW_CTRL_BUDGET =
{
	4,
	{
		{ dump_RDD_EMAC_FLOW_CTRL_BUDGET_ENTRY, 0x3ac0 },
		{ 0, 0 },
	}
};
#endif
...
#endif
#if defined BCM6878
	{ "EPON_DDR_CACHE_FIFO", 1, CORE_0_INDEX, &EPON_DDR_CACHE_FIFO, 96, 1, 1 },
#endif
#if defined BCM6878
...
#endif
#if defined BCM6878
	{ "US_TM_DDR_QUEUES_BASE_PTR", 1, CORE_0_INDEX, &US_TM_DDR_QUEUES_BASE_PTR, 9, 1, 1 },
#endif
#if defined BCM6878
	{ "US_TM_WAN_0_BBH_TX_WAKE_UP_DATA_TABLE", 1, CORE_0_INDEX, &US_TM_WAN_0_BBH_TX_WAKE_UP_DATA_TABLE, 1, 1, 1 },
#endif
#if defined BCM6878
	{ "US_TM_DDR_PD", 1, CORE_0_INDEX, &US_TM_DDR_PD, 1, 1, 1 },
#endif
#if defined BCM6878
...
#endif
#if defined BCM6878
	{ "EPON_DDR_QUEUE_DESCRIPTORS_TABLE", 1, CORE_0_INDEX, &EPON_DDR_QUEUE_DESCRIPTORS_TABLE, 8, 1, 1 },
#endif
#if defined BCM6878
...
#endif
#if defined BCM6878
	{ "EPON_DDR_QUEUE_ADDRESS_TABLE", 1, CORE_0_INDEX, &EPON_DDR_QUEUE_ADDRESS_TABLE, 8, 1, 1 },
#endif
#if defined BCM6878
...
#endif
#if defined BCM6878
	{ "US_TM_DDR_QUEUES_WR_IDX", 1, CORE_0_INDEX, &US_TM_DDR_QUEUES_WR_IDX, 9, 1, 1 },
#endif
#if defined BCM6878
...
#endif
#if defined BCM6878
	{ "US_TM_DDR_QUEUES_RD_IDX", 1, CORE_0_INDEX, &US_TM_DDR_QUEUES_RD_IDX, 9, 1, 1 },
#endif
#if defined BCM6878
	{ "SERVICE_QUEUES_UPDATE_FIFO_TABLE", 1, CORE_0_INDEX, &SERVICE_QUEUES_UPDATE_FIFO_TABLE, 8, 1, 1 },
#endif
#if defined BCM6878
	{ "US_TM_DDR_QUEUES_CTR", 1, CORE_0_INDEX, &US_TM_DDR_QUEUES_CTR, 9, 1, 1 },
#endif
#if defined BCM6878
