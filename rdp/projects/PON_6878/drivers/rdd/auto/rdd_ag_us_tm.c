...
int rdd_ag_us_tm_ddr_queues_wr_idx_set(uint32_t _entry, uint16_t bits)
{
    if(_entry >= RDD_US_TM_DDR_QUEUES_WR_IDX_SIZE)
          return BDMF_ERR_PARM;

    RDD_BYTES_2_BITS_WRITE_G(bits, RDD_US_TM_DDR_QUEUES_WR_IDX_ADDRESS_ARR, _entry);

    return BDMF_ERR_OK;
}

int rdd_ag_us_tm_ddr_queues_wr_idx_get(uint32_t _entry, uint16_t *bits)
{
    if(_entry >= RDD_US_TM_DDR_QUEUES_WR_IDX_SIZE)
          return BDMF_ERR_PARM;

    RDD_BYTES_2_BITS_READ_G(*bits, RDD_US_TM_DDR_QUEUES_WR_IDX_ADDRESS_ARR, _entry);

    return BDMF_ERR_OK;
}

int rdd_ag_us_tm_ddr_queues_rd_idx_set(uint32_t _entry, uint16_t bits)
{
    if(_entry >= RDD_US_TM_DDR_QUEUES_RD_IDX_SIZE)
          return BDMF_ERR_PARM;

    RDD_BYTES_2_BITS_WRITE_G(bits, RDD_US_TM_DDR_QUEUES_RD_IDX_ADDRESS_ARR, _entry);

    return BDMF_ERR_OK;
}

int rdd_ag_us_tm_ddr_queues_rd_idx_get(uint32_t _entry, uint16_t *bits)
{
    if(_entry >= RDD_US_TM_DDR_QUEUES_RD_IDX_SIZE)
          return BDMF_ERR_PARM;

    RDD_BYTES_2_BITS_READ_G(*bits, RDD_US_TM_DDR_QUEUES_RD_IDX_ADDRESS_ARR, _entry);

    return BDMF_ERR_OK;
}

int rdd_ag_us_tm_ddr_queues_ctr_set(uint32_t _entry, uint16_t bits)
{
    if(_entry >= RDD_US_TM_DDR_QUEUES_CTR_SIZE)
          return BDMF_ERR_PARM;

    RDD_BYTES_2_BITS_WRITE_G(bits, RDD_US_TM_DDR_QUEUES_CTR_ADDRESS_ARR, _entry);

    return BDMF_ERR_OK;
}

int rdd_ag_us_tm_ddr_queues_ctr_get(uint32_t _entry, uint16_t *bits)
{
    if(_entry >= RDD_US_TM_DDR_QUEUES_CTR_SIZE)
          return BDMF_ERR_PARM;

    RDD_BYTES_2_BITS_READ_G(*bits, RDD_US_TM_DDR_QUEUES_CTR_ADDRESS_ARR, _entry);
