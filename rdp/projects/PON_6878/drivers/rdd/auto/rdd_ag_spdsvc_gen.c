...
int rdd_ag_spdsvc_gen_udpspdtest_stream_tx_stat_table_set(uint32_t tx_packets_0, uint32_t tx_packets_1, uint32_t tx_drops_no_spbm)
{
...
int rdd_ag_spdsvc_gen_udpspdtest_stream_tx_stat_table_get(uint32_t *tx_packets_0, uint32_t *tx_packets_1, uint32_t *tx_drops_no_spbm)
{
