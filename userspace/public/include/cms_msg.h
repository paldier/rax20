...
typedef enum 
{
   ...
   CMS_MSG_MCPD_RESET	                        = 0x10000277, /**< Sent to mcpd to force it clean up all objects and flush snooping entries*/
...
#if BRCM_PKTCBL_SUPPORT
   CMS_MSG_VOICE_PKTCBL_EVENT                   = 0x10002120, /**< PacketCable event (CmsMsgVoicePktcblEvent) */
#endif /* BRCM_PKTCBL_SUPPORT */
