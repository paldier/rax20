...
#if 0 //defined it in br_dns_ioctl.h, then some user space code can use the define
    /* foxconn wklin added start, 05/14/2010 */
    #define BR_LOCAL_OUT_DHCPC_FILTER  128    /* filter dhcp client packets @ bridge */
    #define BR_LOCAL_OUT_DHCPD_FILTER  256    /* filter dhcp server packets @ bridge */
    /* foxconn wklin added end, 05/14/2010 */
    /* Foxconn add start, Max Ding, 10/17/2011 */
    #define BR_LOCAL_OUT_ARP_FILTER    512    /* filter arp packets @ bridge */
    /* Foxconn add end, Max Ding, 10/17/2011 */	
    #define BR_ACOSFLAGS_FRONTHAUL     0x400  /* LAN or WLAN interfaces from LAN(Fronthaul) */
    #define BR_ACOSFLAGS_BACKHAUL      0x800  /* WAN interfaces to root AP (Backhaul) */
#endif
    unsigned    acos_flags;
